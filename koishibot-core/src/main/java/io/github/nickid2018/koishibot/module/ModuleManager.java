...
public class ModuleManager {
    ...
    public static void addModule(KoishiBotModule module) {
    ...
    public static Collection<KoishiBotModule> getModules() {
        return MODULE_MAP.values();
    }

    public static KoishiBotModule getModule(String name) {
    ...
    public static boolean open(GroupInfo group, String moduleName) throws Exception {
        ...
        DATA_READER.updateData(group.getGroupId(), set -> {
            KoishiBotModule module = MODULE_MAP.get(moduleName);
            if (module == null)
                return set;
            set.add(moduleName);
