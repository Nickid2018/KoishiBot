...
import io.github.nickid2018.koishibot.mc.chat.ChatBridgeSetting;
        ...
        AsyncUtil.execute(() -> {
            try {
                ...
                if (split[0].equalsIgnoreCase("add")) {
                        ...
                        if (operation != null && operation.equals("0")) {
                            environment.getMessageSender().sendMessageAwait(context, environment.newText("输入RCON密码"),
                                    (sent, reply) -> {
                                        ...
                                        try {
                                            MCChatBridge.INSTANCE.addServer(new ChatBridgeSetting(
                    ...
                    MCChatBridge.INSTANCE.removeServer(addr);
