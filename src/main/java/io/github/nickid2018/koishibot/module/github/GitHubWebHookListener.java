...
import io.github.nickid2018.koishibot.core.ReflectTarget;
...
public class GitHubWebHookListener implements HttpHandler {
    ...
    public void addHook(String repo, String token) throws IOException {
        ...
        config.addProperty("url", "http://%s:%d/github".formatted(Settings.LOCAL_IP, Settings.OPEN_PORT));
                        ...
                        .forEach(group -> Environments.getEnvironments().stream()
                                ...
                                .ifPresent(environment -> {
                                    MessageContext context = new MessageContext(
                                            environment.getGroup(group), null, environment.chain(), -1);
